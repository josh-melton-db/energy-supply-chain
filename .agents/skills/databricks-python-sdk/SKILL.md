...
Use `databricks-connect` for running Spark code locally against a Databricks cluster or serverless compute.
...
For serverless setup, UC writes, and local datagen patterns, see **[databricks-connect-serverless](../databricks-connect-serverless/SKILL.md)**.
...
- **[databricks-connect-serverless](../databricks-connect-serverless/SKILL.md)** - PySpark on serverless from local IDE/scripts
